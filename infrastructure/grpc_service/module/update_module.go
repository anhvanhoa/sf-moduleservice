...
func (s *moduleService) UpdateModule(ctx context.Context, req *proto_module.UpdateModuleRequest) (*proto_module.UpdateModuleResponse, error) {
	...
	return &proto_module.UpdateModuleResponse{
		Module: moduleProto,
	}, nil
}
