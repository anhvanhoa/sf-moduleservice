...
func (s *moduleChildService) UpdateModuleChild(ctx context.Context, req *proto_module.UpdateModuleChildRequest) (*proto_module.UpdateModuleChildResponse, error) {
	...
	return &proto_module.UpdateModuleChildResponse{
