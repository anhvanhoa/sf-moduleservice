...
func (s *moduleChildService) UpdateModuleChild(ctx context.Context, req *proto.UpdateModuleChildRequest) (*proto.UpdateModuleChildResponse, error) {
	...
	return &proto.UpdateModuleChildResponse{
